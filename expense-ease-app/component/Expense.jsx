...
const Expense = ({ props }) => {
  return (
    <View style={styles.expenseContainer} id={props.id}>
      <Image
        source={{
          uri: "https://media.istockphoto.com/id/1206806317/vector/shopping-cart-icon-isolated-on-white-background.jpg?s=612x612&w=0&k=20&c=1RRQJs5NDhcB67necQn1WCpJX2YMfWZ4rYi1DFKlkNA=",
        }}
